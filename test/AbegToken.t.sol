...
contract AbegTest is Test {
    ...
    bytes32 root = 0x8f0704ea72bc40746e1ba7da33354957b21e9ad4a1df2dd39c959348ec18b837;
    address user1 = 0x012de6DFCf416c3127BaE4366dA565118098AD44;
...
function testClaimed() public {
    bool success = merkle.claim(user.user, user.amount, 1, result.proof);
    assertTrue(success);
}

function testAlreadyClaimed() public {
    merkle.claim(user.user, user.amount, 1, result.proof);
...
//     merkle.claim(user.user, user.amount, 1, fakeProof);
// }
}